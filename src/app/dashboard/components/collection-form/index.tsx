 ...
 */
export const CollectionForm = ({ method, collectionId, onSuccess, closeDialog }: CollectionFormProps) => {
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormDescription className="mt-1 text-muted-foreground text-xs">
									2-100 characters, letters, numbers, spaces, hyphens, parentheses, and underscores only
								</FormDescription>
								<FormControl>
									<Input
							...
							<FormItem>
								...
								<FormControl>
									<Textarea
										...
										aria-describedby={form.formState.errors.descriptions ? 'descriptions-error' : undefined}
									/>
								</FormControl>
