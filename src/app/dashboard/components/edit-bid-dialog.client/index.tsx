...
interface EditBidDialogProps extends React.HTMLAttributes<HTMLDivElement> {
  bid: Bid;
  onBidUpdated: () => void;
}

export function EditBidDialog({ bid, onBidUpdated, ...props }: EditBidDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogChange} {...props}>
